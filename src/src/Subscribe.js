...
class Subscribe extends React.Component {
  ...
  redirectToPurchase() {
    window.open("https://buy.stripe.com/7sI7tC26Tbcqgog4gg");
  }
    ...
    const content = Content(
      <section class="section">
          <div class="container" id = "subscribe-container" style = {{color: "white"}}>
              ...
              <button id="button-style" class="button is-rounded is-link is-hovered" onClick={this.redirectToPurchase}>PURCHASE</button>
