...
class InspirationalMood extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      songarr: [
  ...
  render(){
    ...
    const title = Title("Moods","Inspirational Mood");
    ...
    <div class = "columns">
      ...
      <div class = "column"style = {{paddingTop: 5, textAlign: "center", color: "white"}} id = "homecontent">
          <img src="/images/browse/moods/inspirational.jpg"></img>
     </div> 
...
export default InspirationalMood;
